...
!============
      ...
      integer ivecd                    
C
      integer ii(ivec),jj(ivec),kk(ivec) 
      REAL*8 xparam(ivec),yparam(ivec),zparam(ivec)

C
      REAL*8 hx(ivec),hy(ivec),hz(ivec)   
      REAL*8 hxi(ivec),hyi(ivec),hzi(ivec)
